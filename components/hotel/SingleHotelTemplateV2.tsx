...
export default function SingleHotelTemplateV2({
  ...
  /* WordPress first. Fifty-nine URLs were pasted into this file as a
     slug-to-photograph table — editorial choices with nowhere to edit them,
     three of which pointed at files that were never uploaded. They live on
     each hotel's `hero_image` now; see aat_seed_hotel_images(). */
  const heroImage =
    str(acf.hero_image) ||
