...
function aat_register_fields() {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            // New additions for full field parity
            aat_text('field_aat_tour_why_title', 'Why Us Heading', 'why_title'),
            aat_text('field_aat_tour_itin_eye', 'Itinerary Eyebrow', 'itinerary_eyebrow'),
            aat_text('field_aat_tour_itin_head', 'Itinerary Heading', 'itinerary_title'),
            aat_text('field_aat_tour_stays_eye', 'Stays Eyebrow', 'hotels_eyebrow'),
            aat_text('field_aat_tour_stays_head', 'Stays Heading', 'hotels_title'),
            aat_text('field_aat_tour_incl_eye', 'Inclusions Eyebrow', 'inclusions_eyebrow'),
            aat_text('field_aat_tour_incl_head', 'Inclusions Heading', 'inclusions_title'),
            aat_text('field_aat_tour_dates_head', 'Departure Dates Heading', 'dates_title'),
            aat_text('field_aat_tour_gal_eye', 'Gallery Eyebrow', 'gallery_eyebrow'),
            aat_text('field_aat_tour_faq_eye', 'FAQ Eyebrow', 'faq_eyebrow'),
            aat_text('field_aat_tour_faq_head', 'FAQ Heading', 'faq_title'),
